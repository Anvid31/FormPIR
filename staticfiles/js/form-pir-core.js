...
(function() {
    ...
    const FormPIRCore = {
        ...
        debugScripts: [
            'js/debug-circuitos.js',
            'js/verificacion-final.js'
        ],
        
        // Scripts opcionales removidos - archivos faltantes  
        optionalScripts: [
            // REMOVIDO: 'js/sistema-tipos-inversion-corregido.js' - Archivo faltante
            // REMOVIDO: 'js/sistema-inicializacion-unificado.js' - Archivo faltante
            // REMOVIDO: 'js/console-cleaner.js' - Archivo faltante
        ]
    };
