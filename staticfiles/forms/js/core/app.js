...
class App {
    ...
    async initializeModules() {
        // Tipos de inversión (sistema unificado - ya inicializado)
        if (document.getElementById('t_inv') && window.TiposInversionState) {
            // El sistema ya está inicializado por tipos-inversion-unificado.js
            this.modules.set('tiposInversion', window.TiposInversionState);
        }
