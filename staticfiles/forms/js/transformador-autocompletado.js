...
class TransformadorAutocompletado {
    ...
    resetForm() {
        // Resetear todos los campos y ocultar secciones
        ...
        document.getElementById('campos_potencia').style.display = 'none';
        document.getElementById('resultado_uc').style.display = 'none';
    ...
    updateTipoTransformador() {
        ...
        if (tipo === 'potencia') {
            ...
            document.getElementById('campos_potencia').style.display = 'block';
    ...
    updateCategoria() {
        ...
        if (tipo === 'potencia' && categoria === 'potencia') {
            ...
            // Para transformadores de medición, el "apoyo" representa el nivel
    ...
    updateApoyo() {
        ...
        if (tipo === 'potencia') {
            ...
            // Para transformadores de medición, saltar directamente a calcular UC
    ...
    updateFases() {
        ...
        // Definir potencias disponibles según el tipo y fases
        let potencias = [];
    ...
    calculateUC() {
        ...
        if (tipo === 'potencia' && categoria === 'potencia') {
            try {
                ...
                console.log('Combinación no encontrada en mapping');
            }
        } else if (tipo === 'medicion') {
            try {
                uc = this.ucMapping.medicion[categoria][apoyo];
            } catch (e) {
                console.log('Transformador de medición no encontrado');
            }
        }
    ...
    showResult(uc, descripcion) {
        document.getElementById('uc_transformador_resultado').value = uc;
        document.getElementById('descripcion_transformador_resultado').value = descripcion;
        document.getElementById('resultado_uc').style.display = 'block';
    ...
    updateMessageHelper(message, type = 'info') {
        ...
        const icon = messageP.querySelector('i');
...
function updateUCTransformador() {
    ...
    const tipoSelect = document.getElementById('tipo_transformador');
    const categoriaSelect = document.getElementById('categoria_transformador');
    const apoyoSelect = document.getElementById('apoyo_transformador');
    const ubicacionSelect = document.getElementById('ubicacion_transformador');
    const fasesSelect = document.getElementById('fases_transformador');
